function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["./memory-Cx5L0CYz.js","./index-blyCgqIt.js","./index-DQQ5gMVr.css"]
  }
  return indexes.map((i) => __vite__mapDeps.viteFileDeps[i])
}
import { _ as __vitePreload } from "./index-blyCgqIt.js";
const errors = {
...
async function makeDirHandleFromFileList(fileList) {
  var _a, _b, _c;
  const { FolderHandle, FileHandle } = await __vitePreload(() => import("./memory-Cx5L0CYz.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
  const { FileSystemDirectoryHandle } = await __vitePreload(() => import("./index-blyCgqIt.js").then((n) => n.a), true ? __vite__mapDeps([1,2]) : void 0, import.meta.url);
...
async function makeFileHandlesFromFileList(fileList) {
  const { FileHandle } = await __vitePreload(() => import("./memory-Cx5L0CYz.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
  const { FileSystemFileHandle } = await __vitePreload(() => import("./index-blyCgqIt.js").then((n) => n.F), true ? __vite__mapDeps([1,2]) : void 0, import.meta.url);
